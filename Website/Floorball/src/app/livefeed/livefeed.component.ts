...
import { ApiserviceService, Imatchinfo, Iplayer, Imatchplayerstat, Accel, Linear, Orient } from '../Services/apiservice.service';
...
export class LivefeedComponent implements OnInit {
  ...
  getXformatted(): any[]
  {
    ...
    Jquery.each(this.accel, function(key, value){
      output.push({
          x: this.totalMilliseconds(value.time),
          y: value.x
        });
    });
    return output;
